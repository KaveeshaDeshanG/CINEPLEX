...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['img']) && $_FILES['img']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($_FILES['img']['tmp_name'], $uploadFilePath)) {
            ...
            $stmt = $conn->prepare("INSERT INTO cmovies (name, year, discrip, theater, img) VALUES (?, ?, ?, ?, ?)");
...
<body>
    <form id="film-form" action="addcfilms.php" method="post" enctype="multipart/form-data">
        <div class="container mt-4">
            <h1 class="display-4 text-center">
                <i class="fas fa-film text-primary"></i> MILANO<span class="text-primary"></span>
            </h1>
    ...
    <div class="container mt-5">
        ...
        <tr>
            ...
            <td>
                ...
                <form action="edit_cmovie.php" method="get" style="display:inline;">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <button type="submit" class="btn btn-primary btn-sm">Edit</button>
                </form>
                <form action="delete_cmovie.php" method="post" style="display:inline;">
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
